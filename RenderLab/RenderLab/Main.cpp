...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
	...
	// Register class and create window
	{
		...
		wcex.lpszClassName = L"EngineDevRenderWindowClass";
		...
		// Create window
		int w, h;
		g_renderer->GetDefaultSize(w, h);

		RECT rc = { 0, 0, static_cast<LONG>(w), static_cast<LONG>(h) };

		AdjustWindowRect(&rc, WS_OVERLAPPEDWINDOW, FALSE);

		HWND hwnd = CreateWindowExW(0, L"EngineDevRenderWindowClass", L"stuff", WS_OVERLAPPEDWINDOW,
		...
		SetWindowLongPtr(hwnd, GWLP_USERDATA, reinterpret_cast<LONG_PTR>(g_renderer.get()));

		GetClientRect(hwnd, &rc);

		g_renderer->Initialize(hwnd, rc.right - rc.left, rc.bottom - rc.top);
	}
	// Main message loop
	MSG msg = {};
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	auto renderer = reinterpret_cast<end::renderer*>(GetWindowLongPtr(hWnd, GWLP_USERDATA));
